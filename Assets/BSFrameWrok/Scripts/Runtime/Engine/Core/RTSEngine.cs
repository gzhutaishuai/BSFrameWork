...
namespace RTSGame
{
    public static class RTSEngine
    {
        ...
        public static void Initialize(MonoBehaviour behaviour)
        {
            ...
            if (_behaviour != null)
                throw new Exception($"{nameof(RTSEngine)} is already initialized.");
        ...
        public static T CreateModule<T>(System.Object createParam, int priority = 0) where T : class, IModule
        {
            ...
            Debug.Log($"Create game module:{typeof(T)}");
        ...
        public static T GetModule<T>() where T : class, IModule
        {
            ...
            Debug.LogWarning($"Not found game module {type}");
            return null;
        }
        ...
        {
            if (_behaviour == null)
                throw new Exception($"{nameof(RTSEngine)} is not initialize. Use MotionEngine.Initialize");
